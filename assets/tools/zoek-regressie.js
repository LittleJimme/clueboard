...
window.zoekRegressie = (function(){
  const LEVELS = [
    "Terug in de tijd 1v6 Herberg de Doortocht.json",
    "Terug in de tijd 2v5 Een hinderlaag vol struikrovers.json",
    "Terug in de tijd 3v6 De Watermolen.json",
    "Terug in de tijd 4v6 De Kathedraal.json",
    "Terug in de tijd 5v12 De Kerkers.json",
    "Terug in de tijd 6v8 Het Fort.json",
    "Terug in de tijd 7v7 De Viersprong.json",
    "Terug in de tijd 8v3 De koningklijke jachtpartij.json",
    "Terug in de tijd 9v2 De Ambachtsstraat.json",
    "Terug in de tijd 10v5 De taverne.json",
